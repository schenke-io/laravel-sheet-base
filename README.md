...
| method             | definition                                                                      |    |
|--------------------|---------------------------------------------------------------------------------|----|
| addUnsigned        | integer equal or larger than 0, preserving null                                 |    |
| addUnsignedNotNull | integer equal or larger than 0, making null to 0                                |    |
| addFloat           | result is float or null                                                         |    |
| addBool            | takes any type of input and returns accurate boolean                            |    |
| addString          | string or empty string                                                          |    |
| addLanguage        | requires language code as name                                                  |    |
| addDateTime        | ISO timestamp generated by Carbon                                               |    |
| addId              | numeric id field                                                                |    |
