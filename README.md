[![License](https://img.shields.io/github/license/schenke-io/laravel-sheet-base?style=flat)](https://github.com/schenke-io/laravel-sheet-base/blob/main/LICENSE.md)
[![PHP](https://img.shields.io/packagist/php-v/schenke-io/laravel-sheet-base?style=flat)](https://packagist.org/packages/schenke-io/laravel-sheet-base)
[![Latest Version](https://img.shields.io/packagist/v/schenke-io/laravel-sheet-base?style=flat-square)](https://packagist.org/packages/schenke-io/laravel-sheet-base)
[![Tests](https://github.com/schenke-io/laravel-sheet-base/actions/workflows/run-tests.yml/badge.svg?branch=main)](https://github.com/schenke-io/laravel-sheet-base/actions/workflows/run-tests.yml)
[![Total Downloads](https://img.shields.io/packagist/dt/schenke-io/laravel-sheet-base?style=flat-square)](https://packagist.org/packages/schenke-io/laravel-sheet-base)
[![Coverage](.github/coverage.svg)](.github/coverage.svg)
[![PHPStan](.github/phpstan.svg)](.github/phpstan.svg)
...
*  workbench/app/Console/Commands/MakeReleaseCommand.php
...
********************************************************************************
-->
# <a name="laravel-sheet-base"></a>Laravel Sheet Base
...
## <a name="supported-readers"></a>Supported Readers
...
## <a name="supported-writers"></a>Supported Writers
...
## <a name="schema-building-blocks"></a>Schema building blocks
...
## <a name="pipeline-pumping-process"></a>Pipeline Pumping Process
...
### <a name="schema-columns"></a>Schema columns
...
##### <a name="extending-existing-classes"></a>Extending Existing Classes
...
##### <a name="using-filename-extensions"></a>Using Filename Extensions
...
##### <a name="extension-and-endpoints"></a>Extension and endpoints
...
#### <a name="endpoints-as-array"></a>Endpoints as array
...
#### <a name="endpoint-to-write-language-files"></a>Endpoint to write language files
...
#### <a name="endpoint-to-read-google-sheets"></a>Endpoint to read Google Sheets
